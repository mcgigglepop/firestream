  ...
  c.extend(p.prototype, {
    ...
    fnGetPosition: function (a) {
      ...
      if (c(a).parents('.DTFC_Cloned').length) {
        if ('tr' === a.nodeName.toLowerCase())
          return (
            (a = c(a).index()), b.fnGetPosition(c('tr', this.s.dt.nTBody)[a])
          );
        var d = c(a).index();
        ...
        l.on('draw.dt.DTFC', function () {
          ...
          .on('position.dts.dt.DTFC', function (a, d) {
            b.dom.grid.left.body &&
              c(b.dom.grid.left.body).find('table').eq(0).css('top', d);
            b.dom.grid.right.body &&
              c(b.dom.grid.right.body).find('table').eq(0).css('top', d);
          })
      ...
      c.each(this.s.dt.aoColumns, function (h, f) {
        ...
        if (f.filter(':visible').length) {
          ...
          if (0 === a.s.aiOuterWidths.length) {
            ...
            m +=
              'string' === typeof l && -1 === l.indexOf('px')
                ? 1
                : parseInt(l, 10);
          }
          a.s.aiOuterWidths.length === a.s.dt.aoColumns.length - 1 &&
            ((l = c(a.s.dt.nTable).css('border-right-width')),
            (m +=
              'string' === typeof l && -1 === l.indexOf('px')
                ? 1
                : parseInt(l, 10)));
    ...
    _fnGridSetup: function () {
      ...
      this.s.dt.nTFoot &&
        ...
        0 < this.s.iLeftColumns && (this.dom.grid.left.foot = d.childNodes[2]),
    ...
    _fnGridLayout: function () {
        ...
        e = function (b, d) {
          f.bar
            ? a._firefoxScrollError()
              ? 34 < c(b).height() && (b.style.width = d + f.bar + 'px')
      ...
      0 < this.s.iRightColumns &&
        ...
        (h.style.height = '1px'),
        this.s.rtl
          ? ((h.style.left = f.y ? f.bar + 'px' : 0), (h.style.right = ''))
          : ((h.style.left = ''), (h.style.right = f.y ? f.bar + 'px' : 0)),
      ...
      for (var h = [], f = [], m = [], l = 0, g = a.length; l < g; l++) {
        ...
        for (var w = 0, n = this.s.iTableColumns; w < n; w++)
          if (-1 !== c.inArray(w, b)) {
            ...
            -1 === k
              ? ((k = c(a[l][w].cell).clone(d, !1)[0]),
                f.push(k),
                m.push(a[l][w].cell),
                e.push({ cell: k, unique: a[l][w].unique }))
    ...
    _fnClone: function (a, b, d, h) {
      ...
      if (h) {
        ...
        for (m = g.length; n < m; n++) {
          var t = 0;
          for (k = g[n].length; t < k; t++)
            (p[n][t].cell.className = g[n][t].cell.className),
              c('span.DataTables_sort_icon', p[n][t].cell).each(function () {
                this.className = c(
      ...
      e.oScroller !== q &&
        ...
        b.forcer
          ...
          : ((b.forcer = m.cloneNode(!0)), b.liner.appendChild(b.forcer)));
    ...
    _fnEqualiseHeights: function (a, b, d) {
      if ('none' != this.s.sHeightMatch || 'thead' === a || 'tfoot' === a) {
        ...
        d = 0;
        for (a = b.length; d < a; d++)
          (b[d].style.height = f[d] + 'px'), (e[d].style.height = f[d] + 'px');
      }
    },
