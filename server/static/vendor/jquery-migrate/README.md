...
In your web page, load this plugin _after_ the script tag for jQuery, for example:
...
| Latest release (_may be hotlinked if desired_) | [jquery-migrate-3.4.0.js](https://code.jquery.com/jquery-migrate-3.4.0.js)     | [jquery-migrate-3.4.0.min.js](https://code.jquery.com/jquery-migrate-3.4.0.min.js)     |
